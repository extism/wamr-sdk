...
//  * - `user_data`: a pointer that will be passed to the function when it's
//  called
...
//  */
// void extism_function_set_namespace(ExtismFunction *ptr, const char
// *namespace_);
...
//  * The log level can be either one of: info, error, trace, debug, warn or a
//  more
 ...
 */
const char *extism_version(void) { return extism_wamr_VERSION; }
