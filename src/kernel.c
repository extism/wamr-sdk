...
static wasm_module_t load_extism_kernel(char errormsg[1024]) {
  wasm_module_t module = wasm_runtime_load(
      extism_runtime_wasm, extism_runtime_wasm_len, errormsg, 1024);
  if (module == NULL) {
    // TODO: log error
    puts(errormsg);
    return NULL;
