...
void *extism_wamr_plugin_memory(ExtismPlugin *plugin, ExtismHandle offs);

// Allocate Extism memory
ExtismHandle extism_wamr_plugin_memory_alloc(ExtismPlugin *plugin, void *data,
                                             size_t size);

// Get length of allocation in Extism memory
uint64_t extism_wamr_plugin_memory_length(ExtismPlugin *plugin,
                                          ExtismHandle offs);
...
void extism_wamr_plugin_use_kernel(ExtismPlugin *);
void extism_wamr_plugin_use_plugin(ExtismPlugin *);
